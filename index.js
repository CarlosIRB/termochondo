  ...
  (s.prototype.getCanvasSize = function () {
    ...
    (s.prototype.randomise = function () {
      (this.velocity = 30),
        ...
        (this.size = this.generateDecimalBetween(5, 10)),
        (this.posX = 0),
        (this.posY = 0),
      ...
      t.ctx.clearRect(0, 0, t.canvas.clientWidth, t.canvas.clientHeight),
        t.bubblesList.forEach(function (e) {
          e.update(),
            ...
            t.ctx.beginPath(), // Inicia la ruta del círculo
            t.ctx.arc(e.posX, e.posY, e.size / 2, 0, 2 * Math.PI, false), // Dibuja el círculo
            (t.ctx.fillStyle = e.color), // Establece el color del círculo
            t.ctx.fill(), // Rellena el círculo con el color
            t.ctx.closePath(), // Cierra la ruta del círculo
